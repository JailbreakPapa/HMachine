...
bool wdQtPin::UpdatePinColors(const wdColorGammaUB* pOverwriteColor)
{
  wdColorGammaUB pinColor = pOverwriteColor != nullptr ? *pOverwriteColor : GetPin()->GetColor();
