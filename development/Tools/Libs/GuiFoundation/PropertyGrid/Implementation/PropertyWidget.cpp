...
{
  auto pNoTemporaryTransactions = m_pProp->GetAttributeByType<wdNoTemporaryTransactionsAttribute>();
  ...
  if (const wdDefaultValueAttribute* pDefault = m_pProp->GetAttributeByType<wdDefaultValueAttribute>())
  {
    switch (m_iNumComponents)
    {
      ...
      case 2:
      {
        ...
        {
          wdVec2 value = pDefault->GetValue().ConvertTo<wdVec2>();
      ...
      case 3:
      {
        ...
        {
          wdVec3 value = pDefault->GetValue().ConvertTo<wdVec3>();
          m_pWidget[0]->setDefaultValue(value.x);
          m_pWidget[1]->setDefaultValue(value.y);
      ...
      case 4:
      {
        ...
        {
          wdVec4 value = pDefault->GetValue().ConvertTo<wdVec4>();
          m_pWidget[0]->setDefaultValue(value.x);
          m_pWidget[1]->setDefaultValue(value.y);
          m_pWidget[2]->setDefaultValue(value.z);
...
void wdQtPropertyEditorDoubleSpinboxWidget::SlotValueChanged()
{
  ...
  {
    case 1:
      BroadcastValueChanged(wdVariant(m_pWidget[0]->value()).ConvertTo(m_OriginalType));
      break;
    case 2:
  ...
  if (const wdDefaultValueAttribute* pDefault = m_pProp->GetAttributeByType<wdDefaultValueAttribute>())
  {
    switch (m_iNumComponents)
    {
      ...
      case 2:
      {
        ...
        {
          wdVec2I32 value = pDefault->GetValue().ConvertTo<wdVec2I32>();
          m_pWidget[0]->setDefaultValue(value.x);
          m_pWidget[1]->setDefaultValue(value.y);
        }
        break;
      ...
      case 3:
      {
        ...
        {
          wdVec3I32 value = pDefault->GetValue().ConvertTo<wdVec3I32>();
          m_pWidget[0]->setDefaultValue(value.x);
          m_pWidget[1]->setDefaultValue(value.y);
          m_pWidget[2]->setDefaultValue(value.z);
        }
      ...
      case 4:
      {
        ...
        {
          wdVec4I32 value = pDefault->GetValue().ConvertTo<wdVec4I32>();
          m_pWidget[0]->setDefaultValue(value.x);
          m_pWidget[1]->setDefaultValue(value.y);
          m_pWidget[2]->setDefaultValue(value.z);
          m_pWidget[3]->setDefaultValue(value.w);
...
void wdQtPropertyEditorIntSpinboxWidget::SlotValueChanged()
{
  ...
  switch (m_iNumComponents)
  {
    case 1:
      ...
      break;
    case 2:
      newValue = wdVec2I32(m_pWidget[0]->value(), m_pWidget[1]->value());
      break;
    case 3:
      newValue = wdVec3I32(m_pWidget[0]->value(), m_pWidget[1]->value(), m_pWidget[2]->value());
      break;
    case 4:
      newValue = wdVec4I32(m_pWidget[0]->value(), m_pWidget[1]->value(), m_pWidget[2]->value(), m_pWidget[3]->value());
      break;
  }
...
void wdQtPropertyEditorIntSpinboxWidget::SlotSliderValueChanged(int value)
{
  ...
  BroadcastValueChanged(wdVariant(m_pSlider->value()).ConvertTo(m_OriginalType));
}
...
QSize wdQtColorButtonWidget::sizeHint() const
{
  return minimumSizeHint();
}

QSize wdQtColorButtonWidget::minimumSizeHint() const
{
...
{
  const wdRTTI* pType = m_pProp->GetSpecificType();
