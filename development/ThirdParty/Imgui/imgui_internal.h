...
struct ImGuiTable
{
    ...
    ImGuiTableColumnIdx         FrewdeRowsRequest;          // Requested frozen rows count
    ImGuiTableColumnIdx         FrewdeRowsCount;            // Actual frozen row count (== FrewdeRowsRequest, or == 0 when no scrolling offset)
