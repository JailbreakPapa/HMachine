...
wdUInt32 wdImageFormatMappings::ToDxgiFormat(wdImageFormat::Enum format)
{

#define CASE_EZ2DXGI(wd)  \
  case wdImageFormat::wd: \
    return DXGI_FORMAT_##wd
  switch (format)
  {
    default:
...
wdImageFormat::Enum wdImageFormatMappings::FromDxgiFormat(wdUInt32 uiDxgiFormat)
{
#define CASE_DXGI2EZ(wd) \
  case DXGI_FORMAT_##wd: \
    return wdImageFormat::wd
  switch (uiDxgiFormat)
  {
    default:
...
wdUInt32 wdImageFormatMappings::ToFourCc(wdImageFormat::Enum format)
{
  switch (format)
  {
...
wdImageFormat::Enum wdImageFormatMappings::FromFourCc(wdUInt32 uiFourCc)
{
  switch (uiFourCc)
  {
...
WD_STATICLINK_FILE(Texture, Texture_Image_Implementation_ImageFormatMappings);
