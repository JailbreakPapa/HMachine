...
wdGALDeviceCapabilities::wdGALDeviceCapabilities()
{
  ...
  for (int i = 0; i < wdGALShaderStage::ENUM_COUNT; ++i)
  {
...
WD_STATICLINK_FILE(RendererFoundation, RendererFoundation_Device_Implementation_DeviceCapabilities);
