...
void wdCommandBufferPoolVulkan::Initialize(vk::Device device, wdUInt32 graphicsFamilyIndex)
{
  m_device = device;
...
void wdCommandBufferPoolVulkan::DeInitialize()
{
...
vk::CommandBuffer wdCommandBufferPoolVulkan::RequestCommandBuffer()
{
  WD_ASSERT_DEBUG(m_device, "wdCommandBufferPoolVulkan::Initialize not called");
...
void wdCommandBufferPoolVulkan::ReclaimCommandBuffer(vk::CommandBuffer& commandBuffer)
{
  WD_ASSERT_DEBUG(m_device, "wdCommandBufferPoolVulkan::Initialize not called");
