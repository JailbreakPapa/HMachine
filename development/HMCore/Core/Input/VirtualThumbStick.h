...
class WD_CORE_DLL wdVirtualThumbStick : public wdInputDevice
{
  WD_ADD_DYNAMIC_REFLECTION(wdVirtualThumbStick, wdInputDevice);
...
public:
  ...
  /// \param center
  ///   \sa CenterMode.
  void SetInputArea(const wdVec2& vLowerLeft, const wdVec2& vUpperRight, float fThumbstickRadius, float fPriority,
    CenterMode::Enum center = CenterMode::ActivationPoint);

  /// \brief Returns the input area of the virtual thumb-stick.
  void GetInputArea(wdVec2& out_vLowerLeft, wdVec2& out_vUpperRight);
  ...
  void SetTriggerInputSlot(Input::Enum input, const wdInputActionConfig* pCustomConfig = nullptr);
  ...
  void SetAreaFocusMode(wdInputActionConfig::OnEnterArea onEnter, wdInputActionConfig::OnLeaveArea onLeave);
...
protected:
  ...
  wdVec2 m_vLowerLeft;
  wdVec2 m_vUpperRight;
  float m_fRadius;

  wdInputActionConfig m_ActionConfig;
