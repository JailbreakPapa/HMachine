...
class WD_CORE_DLL wdCommandInterpreterLua : public wdCommandInterpreter
{
public:
  /// \brief The default interpreter used by wdConsole. Uses Lua for parsing and execution.
  ///
  /// The Lua interpreter can modify wdCVar variables and call wdConsoleFunction functions.
  ///
  ...
  ///
  /// If there is any kind of error (e.g. a Lua syntax error), the interpreter will return WD_FAILURE;
