...
find_package_handle_standard_args(wdOpenXR DEFAULT_MSG WD_OPENXR_LOADER_DIR)
find_package_handle_standard_args(wdOpenXR DEFAULT_MSG WD_OPENXR_HEADERS_DIR)
find_package_handle_standard_args(wdOpenXR DEFAULT_MSG WD_OPENXR_REMOTING_DIR)

if(WDOPENXR_FOUND)
	add_library(wdOpenXR::Loader SHARED IMPORTED)

	if(OPENXR_DYNAMIC)
		set_target_properties(wdOpenXR::Loader PROPERTIES IMPORTED_LOCATION "${WD_OPENXR_LOADER_DIR}/native/${OPENXR_BIN_PREFIX}/release/bin/openxr_loader.dll")
		set_target_properties(wdOpenXR::Loader PROPERTIES IMPORTED_LOCATION_DEBUG "${WD_OPENXR_LOADER_DIR}/native/${OPENXR_BIN_PREFIX}/release/bin/openxr_loader.dll")
	endif()

	set_target_properties(wdOpenXR::Loader PROPERTIES IMPORTED_IMPLIB "${WD_OPENXR_LOADER_DIR}/native/${OPENXR_BIN_PREFIX}/release/lib/openxr_loader.lib")
	set_target_properties(wdOpenXR::Loader PROPERTIES IMPORTED_IMPLIB_DEBUG "${WD_OPENXR_LOADER_DIR}/native/${OPENXR_BIN_PREFIX}/release/lib/openxr_loader.lib")

	set_target_properties(wdOpenXR::Loader PROPERTIES INTERFACE_INCLUDE_DIRECTORIES "${WD_OPENXR_HEADERS_DIR}/include")
	...
	if(WD_CMAKE_PLATFORM_WINDOWS_DESKTOP AND WD_CMAKE_ARCHITECTURE_64BIT)
		...
		add_library(wdOpenXR::Remoting SHARED IMPORTED)
		set_target_properties(wdOpenXR::Remoting PROPERTIES IMPORTED_LOCATION ${WD_OPENXR_REMOTING_DIR}/build/native/Microsoft.Holographic.Remoting.OpenXr.targets)
	endif()

	wd_uwp_mark_import_as_content(wdOpenXR::Loader)
endif()
